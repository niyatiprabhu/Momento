...
struct GlobalVariables {
    ...
    static let firstPost = JournalEntry(photoUpload: UIImage(named: "placeholder")!, textResponse: "hello", todayDate: oldDate, user: currentUser, backgroundColor: UIColor.white)
